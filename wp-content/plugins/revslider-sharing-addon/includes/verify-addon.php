...
class Revslider_Sharing_Addon_Verify {
	
	private $notice = false,
			$min_rev_slider = '6.0',
			$addon_title = 'Sharing',
			$text_domain = 'revslider-sharing-addon',
			$notice_slug = 'revslider_sharing_addon';
	...
	public function enqueue_notice_script() {
		...
		wp_enqueue_script($this->text_domain . '-notice', REV_ADDON_SHARING_URL . 'admin/assets/js/dismiss-admin-notice.js', array('jquery'), REV_ADDON_SHARING_VERSION, true);
